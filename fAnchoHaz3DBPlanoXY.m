...
ax = gca;
set(ax,'FontSize', 13);
title(['Corte del diagrama en \phi_{0} = ',num2str(yLobPrin),'º'],'FontSize',20,'FontName', 'Times New Roman');
...
if length(ordenCasoTheta) == 1
    ...
    ax = gca;
    set(ax,'FontSize', 13);
    title(['Corte del diagrama en \theta_{0} = ',num2str(xLobPrin),'º'],'FontSize',20,'FontName', 'Times New Roman');
